...
if [ $(validateGUID ${accountDetails[azureUsernameObjectId]}) = "false" ]; then
    if [ $(validateGUID ${azureUsernameObjectId}) = "false" ]; then
        ...
        userOutput "STATUS" "Please update the bicep/main.parameters.json file replacing REPLACE_SYNAPSE_AZURE_AD_ADMIN_OBJECT_ID value with your users AAD object_id."
        userOutput "STATUS" "Example: update \"value\": \"REPLACE_SYNAPSE_AZURE_AD_ADMIN_OBJECT_ID\" to \"value: \"1eff46ca-fd6b-3534-40c6-5b4686950a76\"."
        exit 1;
    else
